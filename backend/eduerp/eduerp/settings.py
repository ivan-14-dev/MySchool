...
if not os.path.exists(os.path.join(BASE_DIR, '.env')):
    print("Le fichier .env est manquant à la racine du projet.")
    raise FileNotFoundError("Le fichier .env est manquant à la racine du projet.")
print(env("DB_NAME"))
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'eduerp.log',
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL', default='noreply@eduerp.com')
